...
(function() {
  ...
  EKMDP = function() {
    var EKMDP_Field, __s, _i, _s, j, k, l, len, m, n, o, ref, ref1, ref2, ref3, ref4, ref5;
    EKMDP_Field = document.createElement("div");
    EKMDP_Field.id = "_ekmdp_field";
    document.body.appendChild(EKMDP_Field);
    EKMDP_Field.innerHTML += "<noscript> Ensatone - KMD - Pseudocode (EKMDP) 1.0v <br> 2022 Yangon, Burma <br> Made by Shinn Thant Htoon@Ensatone </noscript>";
    this._variables = {};
    ...
    for (_s = o = 0, ref5 = this._script.length; (0 <= ref5 ? o < ref5 : o > ref5); _s = 0 <= ref5 ? ++o : --o) {
      if (this._script[_s] === "next" && this._script[_s + 1] === "loop") {
        this._script[_s] = "end";
        this._script[_s + 1] = "while";
      }
    }
    this._lex = function() {
      var _l, p, ref6, results;
      results = [];
      for (_l = p = 0, ref6 = this._script.length; (0 <= ref6 ? p < ref6 : p > ref6); _l = 0 <= ref6 ? ++p : --p) {
